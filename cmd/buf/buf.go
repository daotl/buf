...
import (
	...
	"github.com/daotl/buf/cmd/buf/internal/command/alpha/protoc"
	"github.com/daotl/buf/cmd/buf/internal/command/alpha/registry/token/tokendelete"
	"github.com/daotl/buf/cmd/buf/internal/command/alpha/registry/token/tokenget"
	"github.com/daotl/buf/cmd/buf/internal/command/alpha/registry/token/tokenlist"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/bufpluginv1"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/bufpluginv1beta1"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/bufpluginv2"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/price"
	betaplugindelete "github.com/daotl/buf/cmd/buf/internal/command/beta/registry/plugin/plugindelete"
	betapluginpush "github.com/daotl/buf/cmd/buf/internal/command/beta/registry/plugin/pluginpush"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/registry/webhook/webhookcreate"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/registry/webhook/webhookdelete"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/registry/webhook/webhooklist"
	"github.com/daotl/buf/cmd/buf/internal/command/beta/studioagent"
	"github.com/daotl/buf/cmd/buf/internal/command/breaking"
	"github.com/daotl/buf/cmd/buf/internal/command/build"
	"github.com/daotl/buf/cmd/buf/internal/command/config/configinit"
	"github.com/daotl/buf/cmd/buf/internal/command/config/configlsbreakingrules"
	"github.com/daotl/buf/cmd/buf/internal/command/config/configlslintrules"
	"github.com/daotl/buf/cmd/buf/internal/command/config/configlsmodules"
	"github.com/daotl/buf/cmd/buf/internal/command/config/configmigrate"
	"github.com/daotl/buf/cmd/buf/internal/command/convert"
	"github.com/daotl/buf/cmd/buf/internal/command/curl"
	"github.com/daotl/buf/cmd/buf/internal/command/dep/depgraph"
	"github.com/daotl/buf/cmd/buf/internal/command/dep/depprune"
	"github.com/daotl/buf/cmd/buf/internal/command/dep/depupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/export"
	"github.com/daotl/buf/cmd/buf/internal/command/format"
	"github.com/daotl/buf/cmd/buf/internal/command/generate"
	"github.com/daotl/buf/cmd/buf/internal/command/lint"
	"github.com/daotl/buf/cmd/buf/internal/command/lsfiles"
	"github.com/daotl/buf/cmd/buf/internal/command/lsp/lspserve"
	"github.com/daotl/buf/cmd/buf/internal/command/mod/modlsbreakingrules"
	"github.com/daotl/buf/cmd/buf/internal/command/mod/modlslintrules"
	"github.com/daotl/buf/cmd/buf/internal/command/mod/modopen"
	"github.com/daotl/buf/cmd/buf/internal/command/plugin/pluginprune"
	"github.com/daotl/buf/cmd/buf/internal/command/plugin/pluginpush"
	"github.com/daotl/buf/cmd/buf/internal/command/plugin/pluginupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/policy/policyprune"
	"github.com/daotl/buf/cmd/buf/internal/command/policy/policypush"
	"github.com/daotl/buf/cmd/buf/internal/command/policy/policyupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/push"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulecommit/modulecommitaddlabel"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulecommit/modulecommitinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulecommit/modulecommitlist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulecommit/modulecommitresolve"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulecreate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/moduledelete"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/moduledeprecate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/moduleinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulelabel/modulelabelarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulelabel/modulelabelinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulelabel/modulelabellist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulelabel/modulelabelunarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/modulesettings/modulesettingsupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/module/moduleundeprecate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/organization/organizationcreate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/organization/organizationdelete"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/organization/organizationinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/organization/organizationupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugincommit/plugincommitaddlabel"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugincommit/plugincommitinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugincommit/plugincommitlist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugincommit/plugincommitresolve"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugincreate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugindelete"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/plugininfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/pluginlabel/pluginlabelarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/pluginlabel/pluginlabelinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/pluginlabel/pluginlabellist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/pluginlabel/pluginlabelunarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/plugin/pluginsettings/pluginsettingsupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policycommit/policycommitaddlabel"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policycommit/policycommitinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policycommit/policycommitlist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policycommit/policycommitresolve"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policycreate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policydelete"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policyinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policylabel/policylabelarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policylabel/policylabelinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policylabel/policylabellist"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policylabel/policylabelunarchive"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/policy/policysettings/policysettingsupdate"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/registrycc"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/registrylogin"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/registrylogout"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/sdk/sdkinfo"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/sdk/version"
	"github.com/daotl/buf/cmd/buf/internal/command/registry/whoami"
	"github.com/daotl/buf/cmd/buf/internal/command/source/sourceedit/sourceeditdeprecate"
	"github.com/daotl/buf/cmd/buf/internal/command/stats"
	"github.com/daotl/buf/private/buf/bufcli"
	"github.com/daotl/buf/private/buf/bufctl"
	"github.com/daotl/buf/private/bufpkg/bufcobra"
	...
	if isSysError {
		err = fmt.Errorf(
			"it looks like you have found a bug in buf. "+
				"Please file an issue at https://github.com/daotl/buf/issues "+
